...
// Primus oyun sabitleri (PRIMUS_GRID_SIZE / TARGET / ROUND_TIME / MIN_ONE_DIGIT = alıştırma varsayılanları)
export const PRIMUS_MAX_LEVEL = 19
...
/** Yalnızca Alıştırma/DEBUG (practice) modunda son-5 tip garantisi için kullanılır */
...
export const PRIMUS_PRACTICE_SAVE_KEY = 'primus_practice_save'
...
export const PRIMUS_THREE_DIGIT_MIN = 100
export const PRIMUS_THREE_DIGIT_MAX = 999
